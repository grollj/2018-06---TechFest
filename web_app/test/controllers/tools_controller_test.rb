...
class ToolsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tool" do
    assert_difference('Tool.count') do
      post tools_url, params: { tool: { bt_id: @tool.bt_id, latitude: @tool.latitude, longitude: @tool.longitude, name: @tool.name, type: @tool.type } }
    end
  ...
  test "should update tool" do
    patch tool_url(@tool), params: { tool: { bt_id: @tool.bt_id, latitude: @tool.latitude, longitude: @tool.longitude, name: @tool.name, type: @tool.type } }
